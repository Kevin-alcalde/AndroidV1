...
public class Jugador implements Serializable {
    ...
    List<Item> itemsByPlayer;
        ...
        public Jugador(String s, String toString, String string, String s1, String toString1, String string1) {
        }
        ...
        public Jugador(String username, String mail, String name, String lastname, String city, String password, boolean connected) {
            //nuevo constructor
        ...
        public Jugador(String username, String password, boolean connected) {
            this.username = username;
            this.password = password;
            this.connected = connected;
        }
        ...
        public Jugador(String id, String username, String mail, String name, String lastname, String city, String password, String image, boolean connected, int actualLife, int maxLife, int attack, int checkPoint, int points, int enemiesKilled, String level) {
            this.id = id;
            this.username = username;
            this.mail = mail;
            this.name = name;
